...
import BibLaTeXParser (parseFile, parseEntry, bibtexString, parse)
...
main = do
   ...
   let result = parse (bibtexString False) Map.empty  "This \\^i is an \\important example of the many text commands of LaTeX. \
